...
class BasketAdapter(private val f:BasketFragment, var list: List<ProductResponse>) : AbstractProductsAdapter(list){
    ...
    override fun getCartClickListener(productId: Long): View.OnClickListener = ProductCartClickListener(f, productId)
